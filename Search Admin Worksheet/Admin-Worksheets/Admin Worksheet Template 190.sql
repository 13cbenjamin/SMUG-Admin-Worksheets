...
#############################################################
Worksheet ID: 190
WOrksheet Type: Admin
Worksheet Name: Debtor Employer Search by DBA/AKA
This admin worksheet will be used to replace 3 TNG Views 
(Debtor Search AKA, Debtor Search DBA, Employer Search DBA)
#############################################################
*/ 

--Code below neesd to be copied to WOrksheet Template. 
--If ID is different than 190, please update all references
--to 190 do you worksheet ID.
--Since this is an admin worksheet, the CaseNumber used is always -8888888
    ...
    <table class="table table-bordered" style="width:auto;background:#FFFFFF;"> 
        <thead> 
            ...
            <tr> 
                ...
                <td>[TextBox1.200]</td> 
                <td><a onclick="displayWorksheet()" title="Search" class="btn btn-success" style="color: #FFFFFF" tabindex="1">Search</a></td>
            </tr> 
        </thead> 
    </table> 
    </br>
...
--Jquery SCRIPT
--Used to detect "enter" key press to show results. 
displayWorksheet()
